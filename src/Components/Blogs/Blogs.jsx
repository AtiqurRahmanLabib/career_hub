...
import { saveJobApllication } from "../../utils/LocalStorage";
...
const Blogs = () => {
    ...
    if (!job) {
        return <h1 className="text-center text-red-500 text-2xl font-bold">Job not found!</h1>;
    }
    ...
    return (
        <div className='mb-[100px]'>
            ...
            <div className='w-[1321px] h-[550px] mx-auto mt-19 grid grid-cols-2 gap-5'>
                ...
                <button onClick={handleJobApply} className="text-[#FFFFFF] bg-gradient-to-r from-[#7E90FE] to-[#9873FF] rounded-[4px] w-[425px] h-[65px] text-[20px] font-extrabold ml-[894px]">Apply Now</button>
            </div>
            <ToastContainer />
        </div>
    );
